...
public class TaccuinoJpaController implements Serializable {
	...
	public void edit(Taccuino taccuino) throws NonexistentEntityException,
			Exception {
		EntityManager em = null;
		try {
			em = EMF.get();
			...
			if (msg == null || msg.length() == 0) {
				...
				if (findTaccuino(id) == null) {
					throw new NonexistentEntityException(
							"The taccuino with id " + id + " no longer exists.");
				}
			}
			throw ex;
		} finally {
	...
	public void destroy(Long id) throws NonexistentEntityException {
		...
		try {
			...
			try {
				...
				throw new NonexistentEntityException("The taccuino with id "
