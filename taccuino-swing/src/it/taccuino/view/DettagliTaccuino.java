...
public class DettagliTaccuino extends javax.swing.JFrame {
    ...
    public DettagliTaccuino(String id) {
       ...
       List<Note> listaNote=noteJpaController.findNoteByIdTaccuino(taccuino.getId());
       int i=0;
    ...
    private void buttonCancellaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonCancellaMouseClicked
        ...
        int value = optionPane.showOptionDialog(this, "Sei sicuro di cancellare la nota?", "Attenzione", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE, null,options , "No");
        if (value == JOptionPane.YES_OPTION)
        {
            ...
            try {
                ...
                Logger.getLogger(DettagliTaccuino.class.getName()).log(Level.SEVERE, null, ex);
            }
            JOptionPane.showMessageDialog(this, "Nota cancellata correttamente", "Info", 1);
    ...
    private void buttonAggiungiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonAggiungiMouseClicked
        String testo;
        testo=JOptionPane.showInputDialog(null,"Inserisci il testo della nota","");
        if (testo!=null)
        {
            Note n=new Note(); 
            n.setTesto(testo);
            ...
            JOptionPane.showMessageDialog(this, "Nota creata correttamente", "Info", 1);
    ...
    private void buttonModificaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonModificaMouseClicked
        ...
        if (testo!=null)
        {
            ...
            JOptionPane.showMessageDialog(this, "Nota modificata correttamente", "Info", 1);    
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DettagliTaccuino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
